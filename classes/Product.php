...
class Product
{
    ...
    public function columnList(): array
    {
        return [
            ...
            'packing_size', 'net_weight', 'gross_weight',
            'units_per_package', 'empty_package_weight', 'gross_weight_formula',
            'package_length', 'package_width', 'package_height', 'package_material',
            'stack_limit', 'pallet_configuration', 'storage_type', 'loading_method', 'container_compatibility',
            'bags_per_container', 'container_type', 'pallet_type', 'shipping_marks',
    ...
    public function insertData(array $d): array
    {
        ...
        return [
            ...
            'units_per_package'          => (isset($d['units_per_package']) && $d['units_per_package'] !== '') ? (float) $d['units_per_package'] : 1.0,
            'empty_package_weight'       => (isset($d['empty_package_weight']) && $d['empty_package_weight'] !== '') ? (float) $d['empty_package_weight'] : 0.0,
            'gross_weight_formula'       => $n('gross_weight_formula', $d),
            'package_length'             => $n('package_length', $d),
            'package_width'              => $n('package_width', $d),
            'package_height'             => $n('package_height', $d),
            'package_material'           => $n('package_material', $d),
            'stack_limit'                => (isset($d['stack_limit']) && $d['stack_limit'] !== '') ? (int) $d['stack_limit'] : null,
            'pallet_configuration'       => $n('pallet_configuration', $d),
            'storage_type'               => $n('storage_type', $d),
            'loading_method'             => $n('loading_method', $d),
            'container_compatibility'     => $n('container_compatibility', $d),
