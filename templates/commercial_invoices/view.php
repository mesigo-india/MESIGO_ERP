...
<div class="page-header no-print d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="mb-0 fw-bold"><i class="fas fa-file-signature text-primary me-2"></i>Commercial Invoice <?= escapeHtml($quotation['document_number'] ?? '') ?></h4>
    ...
    <div class="d-flex gap-2">
        ...
        <?php if (\App\Core\Session::get('role_name') === 'admin'): ?>
            <form method="post" action="/commercial-invoices/<?= (int) ($quotation['id'] ?? 0) ?>/delete" class="d-inline" onsubmit="return confirm('Are you sure you want to permanently delete this Commercial Invoice?');">
                <?= csrfToken() ?>
    ...
    <div class="letterhead-content-body card border-0">
        <div class="card-body p-0">
            <div class="text-center mb-4">
                ...
                <div class="text-muted small">Official Transaction Bill of Sale</div>
            </div>
