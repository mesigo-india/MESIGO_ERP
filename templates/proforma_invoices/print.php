    ...
    <div class="letterhead-content-body card border-0">
        <div class="card-body p-0">
            <div class="text-center mb-4">
                ...
                <div class="text-muted small">Commercial Sourcing Agreement (Order Confirmed)</div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-7">
                    ...
                    <div class="p-3 border rounded bg-light mt-3">
                        <strong class="text-secondary d-block small text-uppercase mb-1"><i class="fas fa-calendar-alt me-1"></i> Payment Schedule Agreed</strong>
                        <span class="small text-dark">Advance Received: <strong><?= (float)($meta['advance_percent'] ?? 30.0) ?>%</strong>, Balance Payment: <strong><?= (float)($meta['balance_percent'] ?? 70.0) ?>%</strong></span>
                    </div>
                </div>
