...
<div class="page-header no-print d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="mb-0 fw-bold"><i class="fas fa-file-invoice text-primary me-2"></i>Proforma Invoice <?= escapeHtml($quotation['document_number'] ?? '') ?></h4>
    ...
    <div class="d-flex gap-2">
        ...
        <?php if (\App\Core\Session::get('role_name') === 'admin'): ?>
            <form method="post" action="/proforma-invoices/<?= (int) ($quotation['id'] ?? 0) ?>/delete" class="d-inline" onsubmit="return confirm('Are you sure you want to permanently delete this Proforma Invoice?');">
                <?= csrfToken() ?>
    ...
    <div class="letterhead-content-body card border-0">
        <div class="card-body p-0">
            <div class="text-center mb-4">
                <h4 class="fw-bold tracking-wider text-dark mb-0">PROFORMA INVOICE</h4>
                <div class="text-muted small">Pre-shipment Sourcing Document</div>
            </div>
            
            <div class="row g-3 mb-4">
                <div class="col-6 col-sm-6">
                    <span class="d-block small text-muted text-uppercase">Document Details</span>
            ...
            <div class="row g-3 mb-4 border-top border-bottom py-2 bg-light">
                ...
                <div class="col-sm-3 col-6"><span class="d-block text-muted small">Destination Port</span><span class="fw-semibold text-dark small"><?= escapeHtml($quotation['delivery_port_name'] ?? 'N/A') ?></span></div>
                <div class="col-sm-3 col-6"><span class="d-block text-muted small">Payment Terms</span><span class="fw-semibold text-dark small"><?= escapeHtml($quotation['payment_term_name'] ?? 'N/A') ?></span></div>
                <div class="col-sm-3 col-6"><span class="d-block text-muted small">Shipment Terms</span><span class="fw-semibold text-dark small"><?= escapeHtml($meta['shipment_term'] ?? ($quotation['shipment_type'] ?? 'N/A')) ?></span></div>
            </div>
